...
namespace Exit_3R
{
    public class Exit_3R : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            m_ScreenManager.AddScreen(Mode.HomeRScreen, new HomeRScreen(), Content);
            m_ScreenManager.AddScreen(Mode.SettingScreen, new SettingScreen(), Content);
            m_ScreenManager.AddScreen(Mode.ResoultRScreen, new ResultRScreen(), Content);
