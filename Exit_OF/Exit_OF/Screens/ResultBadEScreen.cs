...
namespace Exit_OF
{
    class ResultBadEScreen : IScreen
    {
        ...
        {
            m_GoodBackgroundImage = content.Load<Texture2D>(@"ResultEScreen\resultBadBackground");
            ...
            failSFX = content.Load<SoundEffect>(@"ResultEScreen\failSFX");
        }
